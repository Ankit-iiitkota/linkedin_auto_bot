...
# Tailor default resume's keywords/skills per job description for better ATS matching (requires use_AI = True in secrets.py and Tectonic installed). Only rewords existing bullets/skills - never changes the resume template, layout, or facts (names, dates, companies, numbers).
tailor_resume_keywords = True       # True or False, Note: True or False are case-sensitive
